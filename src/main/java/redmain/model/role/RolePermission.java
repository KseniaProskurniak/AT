...
public enum RolePermission {
    ...
    MANAGE_CALENDAR("Просмотр календаря"),
    MANAGE_DOCUMENTS("Просмотр документов"),
    ...
    MANAGE_ISSUES_RELATIONS("Управление связыванием задач"),
    ...
    ADD_ISSUES_NOTES("Добавление примечаний"),
    EDIT_ISSUE_NOTES("Редактирование примечаний"),
    ADD_OWN_ISSUE_NOTES("Редактирование собственных примечаний"),
